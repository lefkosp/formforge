    ...
    <DocsLayout>
      <div className="space-y-8">
        ...
        <div className="prose prose-gray dark:prose-invert max-w-none">
          <p>
            FormForge is a comprehensive form library built for React applications that combines the power of React Hook Form with Zod
            validation to create type-safe, accessible, and beautiful forms with minimal boilerplate.
          </p>

          <h2>Key Features</h2>
          <ul>
            <li><strong>Type Safety:</strong> Full TypeScript support with Zod schema validation</li>
            <li><strong>Accessibility:</strong> Built-in ARIA attributes and keyboard navigation</li>
            <li><strong>Customizable:</strong> Flexible theming with Tailwind CSS</li>
            <li><strong>Developer Experience:</strong> Minimal setup, maximum productivity</li>
            <li><strong>Performance:</strong> Optimized rendering with React Hook Form</li>
          </ul>
        ...
        <div className="prose prose-gray dark:prose-invert max-w-none">
          <h2>Installation</h2>
          <pre className="bg-muted p-4 rounded-lg"><code>npm install formforge react-hook-form @hookform/resolvers zod</code></pre>

          <h2>Next Steps</h2>
          <p>
            Explore the components in the sidebar to see all available form fields and their configurations. Each component includes live
